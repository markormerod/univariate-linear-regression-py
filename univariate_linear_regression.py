    ...
    def run_gradient_descent(self, runs, alpha):
        ...
        while runs >= 0:
            ...
            for val in self.normalized:
                ...
                result0 = theta0 - alpha * (1/float(len(self.normalized))) * result0
            for val in self.normalized:
                result1 += ((theta0 + theta1 * val[0]) - val[1]) * val[0]
                result1 = theta1 - alpha * (1/float(len(self.normalized))) * result1
    ...
    def guess_loop(self):
        ...
        while True:
            ...
            try:
                ...
                raw_n = raw_input("Amount of learning iterations: ")
                if raw_n in ["quit", "q"]:
                    print('')
                    sys.quit()
                n = int(raw_n)
